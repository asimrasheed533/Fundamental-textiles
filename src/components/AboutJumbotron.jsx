      ...
      <div className="about__jumbotron">
        ...
        <div className="about__jumbotron__content">
          <div className="about__jumbotron__content__left">
            ...
            the sustainable growth of the company. With our head office based in
          ...
          <div className="about__jumbotron__content__right">
            ...
            product development, production follow up, in line and pre shipment
            inspections and shipping follow ups. We cover all the important
            aspects including the price, ethical production practices, quality
            control, and timely delivery. We have joined hands with some leading
            manufacturing companies based in Pakistan. This strategic
            partnership has enabled us to work in close liaison with our partner
            factories and successfully delivering required supply chain
