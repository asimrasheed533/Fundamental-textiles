...
function HomeProductsCard({}) {
  return (
    <div className="home__products__content__card">
      <img src="" alt="" className="home__products__content__card__img" />
      <div className="home__products__content__card__heading"></div>
      <div className="home__products__content__card__info"></div>
    </div>
  );
}
